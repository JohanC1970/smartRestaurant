...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public void registerEmployee(RegisterAdminRequest request) {
        ...
        emailService.sendNewEmployeeEmail(user.getEmail(), user.getFirstName(), tempPassword);
    }
    ...
    public AuthResponse login(LoginRequest request) {
        ...
        // 2FA Desactivado para pruebas automáticas
        /*
        ...
        return AuthResponse.builder()
                ...
                .email(user.getEmail())
                .role(user.getRole())
                .message("Login exitoso (2FA bypass)")
                .is2faRequired(false)
                .build();
    }
