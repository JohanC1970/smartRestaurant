...
public class AuthenticationServiceImpl implements AuthenticationService {
        ...
        public void resendVerification(String email) {
                ...
                auditService.logEvent(user, AuditEventType.USER_REGISTERED,
                                "Re-envío de código de verificación solicitado", null, null);
        }
        ...
        public void registerEmployee(RegisterAdminRequest request) {
                ...
                // Obtener el restaurante del administrador actual (mejorar con SecurityContext
                // más adelante)
                // Por ahora, asumimos que estamos en un contexto donde sabemos quién registra.
                // En una implementación real, se extraería del token del Admin.
        ...
        public AuthResponse login(LoginRequest request) {
                ...
                if (!passwordEncoder.matches(request.getPassword(), user.getPassword())) {
                        ...
                        if (user.getFailedLoginAttempts() >= 3) {
                                ...
                                throw new AccountLockedException(
                                                "Cuenta bloqueada por seguridad después de varios intentos fallidos.");
                        }
                ...
                // Generar tokens directamente (sin 2FA por ahora)
