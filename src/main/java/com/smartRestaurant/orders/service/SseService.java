...
public interface SseService {
    ...
    /** Notifica al cliente específico de cualquier cambio de estado en su pedido. */
    void notifyCustomerOrderStatusChanged(Long customerId, String status, Object orderData);
}
