...
public class ProductController {
    ...
    @PreAuthorize("hasAnyAuthority('product:write', 'ROLE_ADMIN', 'ROLE_KITCHEN')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('product:delete', 'ROLE_ADMIN', 'ROLE_KITCHEN')")
    ...
    @PreAuthorize("hasAnyAuthority('product:read', 'ROLE_ADMIN', 'ROLE_KITCHEN')")
